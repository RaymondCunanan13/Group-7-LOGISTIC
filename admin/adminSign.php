...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($errors)) {
        $check_query = "SELECT * FROM admin WHERE mobile = ? OR email = ? OR username = ?";
    ...
    if (empty($errors)) {
        $id = uniqid();
        $insert_query = "INSERT INTO admin (id, firstname, lastname, username, password, mobile, address, gender, email, age) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    <div class="container flex">
        <div class="goshdc-page flex">
            <form method="post" onsubmit="return validateForm();">
                ...
                <div class="button">
                    <a href="logAdmin.php">Already Have an Account</a>
                </div>
