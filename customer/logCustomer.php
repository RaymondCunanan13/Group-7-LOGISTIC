...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($username) || empty($password) || is_numeric($username)) {
        ...
        $query = "SELECT * FROM customer WHERE username = ? LIMIT 1";
        ...
        if ($result) {
            if (mysqli_num_rows($result) > 0) {
                ...
                if ($user_data['password'] === $password) {
                    ...
                    header("Location: customerDashboardLogic.php");
                    die;
                } else {
        ...
        <div class="goshdc-page flex">
            ...
            <?php endif; ?><br>
                ...
                <div class="link">
                    ...
                    <a href="changePassCustomer.php" class="forgot">Forgot password?</a>
                </div>
                <hr>
                <div class="button">
                    <a href="customerSign.php">Create new account</a>
                </div>
            </form>
        </div>
    </div>
