...
if (isset($_POST['desired_username']) && isset($_POST['new_password'])) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE customer SET password = :newPassword WHERE username = :desiredUsername");
...
<body>
    ...
    <div class="container flex">
        <div class="goshdc-page flex">
            ...
            <form action="changePassCustomer.php" method="post" onsubmit="return validateForm();">
            ...
            <div class="link">
                <a id="button" href="logCustomer.php">Back to Login</a>
            </div>
